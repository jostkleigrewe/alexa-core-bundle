...
use Jostkleigrewe\AlexaCoreBundle\Enum\Dto\Response\AudioPlayerActivity;
...
{
    /**
     * @param string|null               $token An opaque token that represents the audio stream.
     * @param int|null                  $offsetInMilliseconds Identifies a track's offset in milliseconds at the time of the request.
     * @param AudioPlayerActivity|null  $playerActivity Indicates the last known state of audio playback.
     */
    public function __construct(
        ...
        public ?AudioPlayerActivity $playerActivity = null,
    ) {
        // ...
    }
    ...
    public function getPlayerActivity(): ?AudioPlayerActivity
    {
