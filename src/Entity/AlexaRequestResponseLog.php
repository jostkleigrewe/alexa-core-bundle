...
class AlexaRequestResponseLog
{
    ...
    public function setId(string $id): AlexaRequestResponseLog
    {
        $this->id = $id;
        return $this;
    }
    ...
    public function setRequestMethod(string $requestMethod): AlexaRequestResponseLog
    {
    ...
    public function setRequestPath(string $requestPath): AlexaRequestResponseLog
    {
    ...
    public function setRequestHeaders(array $requestHeaders): AlexaRequestResponseLog
    {
