...
final class AlexaResponseResponseCardImage
{
    ...
    public function setSmallImageUrl(?string $smallImageUrl): AlexaResponseResponseCardImage
    {
    ...
    public function setLargeImageUrl(?string $largeImageUrl): AlexaResponseResponseCardImage
    {
